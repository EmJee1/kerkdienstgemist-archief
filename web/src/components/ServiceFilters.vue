  ...
  <Card class="mb-8">
    <CardContent class="">
      <div class="grid items-end grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Date From Filter -->
        <div class="space-y-2">
          <label class="text-sm block pb-0.5 font-medium">Vanaf</label>
          <Popover>
        ...
        <!-- Date To Filter -->
        <div class="space-y-2">
          <label class="text-sm block pb-0.5 font-medium">Tot</label>
          <Popover>
            <PopoverTrigger as-child>
              <Button
                variant="outline"
        ...
        <!-- Pastor Filter -->
        <div class="space-y-2">
          <label for="pastor" class="text-sm block pb-0.5 font-medium">
            Voorganger
          </label>
          <Select
            :model-value="selectedPastor"
            @update:model-value="
              (value) => $emit('update:selectedPastor', value as string)
            "
          >
            <SelectTrigger id="pastor" class="w-full">
